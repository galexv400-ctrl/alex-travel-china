# Pre-Trip Checklist — China & Japan 2026
...
## Apps — Install & Set Up BEFORE Leaving Israel

- [ ] VPN — install and test before departure (Google, WhatsApp, Instagram blocked in mainland China)
- [ ] WeChat — create account, link foreign bank card
- [ ] Alipay — create account, link foreign bank card
- [ ] DiDi — Chinese Uber, set up with foreign card
- [ ] Baidu Maps — download offline maps for all cities
- [ ] Google Translate — download Chinese offline language pack
- [ ] China Customs mini-app — for health declaration
...
- Layers — northern China 5–12°C in early November
...
- [ ] Screenshot itinerary and save offline
- [ ] Share full itinerary with someone at home
- [ ] Portable charger packed and charged
